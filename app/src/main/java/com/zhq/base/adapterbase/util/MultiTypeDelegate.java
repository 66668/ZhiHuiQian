package com.zhq.base.adapterbase.util;

import android.support.annotation.LayoutRes;
import android.util.SparseIntArray;

import com.zhq.base.adapterbase.BaseiItemMultiQuickAdapter;
...
public abstract class MultiTypeDelegate<T> {
    ...
    public final int getLayoutId(int viewType) {
        return this.layouts.get(viewType, BaseiItemMultiQuickAdapter.TYPE_NOT_FOUND);
    }
